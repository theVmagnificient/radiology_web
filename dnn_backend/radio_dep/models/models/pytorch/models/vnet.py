...
from ..blocks import VanillaVNetEncoder, VanillaVNetDecoder
...
class VNet(EncoderDecoder):
    ...
    @classmethod
    def encoder(cls, input_shape, filters, layout='cna', kernel_size=5,
    ...
    @classmethod
    def decoder(cls, input_shape, skip_shape, filters, layout='cna',
