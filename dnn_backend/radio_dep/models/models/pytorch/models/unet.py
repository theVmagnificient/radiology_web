...
from ..blocks import VanillaUNetEncoder, VanillaUNetDecoder
from ..blocks import GCNBlock, NonLocalBlock, BaseDecoder
...
class UNet(EncoderDecoder):
    ...
    @classmethod
    def encoder(cls, input_shape, filters, layout='cna', kernel_size=3,
    ...
    @classmethod
    def decoder(cls, input_shape, skip_shape, filters,
...
class UNetGCN(UNet):
    ...
    def default_config(cls):
        ...
        config['body_block/encoder/kernel_size'] = 11
        return config

    @classmethod
    def encoder(cls, input_shape, filters, kernel_size=11, downsample=False):
        shape = input_shape
    ...
    @classmethod
    def decoder(cls, input_shape, skip_shape, filters, kernel_size=11):
...
class NonLocalEncoderUNet(UNet):
    ...
    @classmethod
    def encoder(cls, input_shape, filters, kernel_size=3,
