...
class BaseDecoder(Module):
    ...
    def __init__(self, input_shape, skip_shape,
        ...
        self.skip_block = skip_block(input_shape=skip_shape) if skip_block else None
        self.input_block = input_block(input_shape=input_shape) if input_block else None
        self.how = how
